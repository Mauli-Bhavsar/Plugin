...
//    ConsoleProgressIndicator indicator1 = new ConsoleProgressIndicator(2);
...
//    indicator1.setFraction(0.50);
//    indicator1.setText("Extracting packages from Spring XML files...");
