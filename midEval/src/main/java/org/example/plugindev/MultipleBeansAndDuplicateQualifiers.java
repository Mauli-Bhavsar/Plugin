        ...
        if (allChildClasses.size() > 1) {
            ...
            if (field != null) {
                ...
                if (fieldModifiers != null) {
                    ...
                    if (qualifierAnnotation != null) {
                        handleQualifierAnnotation(qualifierAnnotation, "Field '" + field.getName() + "'", allChildClasses, project);
                        return;
                    }
                }
            }
            if (parameter != null) {
                ...
                if (parameterModifiers != null) {
                    ...
                    if (qualifierAnnotation != null) {
                        handleQualifierAnnotation(qualifierAnnotation, "Parameter '" + parameter.getName() + "'", allChildClasses, project);
                        return;
                    }
                }
            }
