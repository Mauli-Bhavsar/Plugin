...
public class AnnotationChecker {
    ...
    private void showEditorNotification(PsiClass psiClass, String message, Project project) {
    ...
    public void checkAnnotations(@NotNull PsiClass psiClass, @NotNull Project project) {
        ...
        if (hasServiceAnnotation(psiClass)) {
            ...
            payloadChecker.checkAnnotation(psiClass);
        }
    }
    ...
    void warnMissingServiceAnnotation(PsiClass psiClass, Project project) {
        ...
        showEditorNotification(psiClass, message,project);
        logger.warn(message);
    }
    ...
    private void checkMultipleConstructors(PsiMethod[] constructors, PsiClass psiClass, Project project) {
        ...
        checkForMultipleAutowiredConstructors(constructors, psiClass, project);
    }
     ...
     * @param project      the current project
     */
    private void checkForMultipleAutowiredConstructors(PsiMethod[] constructors, PsiClass psiClass, Project project) {
